...
urlpatterns = [
    ...
    path('protocols_de_recherche/', include('protocol.urls')),
    path('mediatheque/', include('mediatheque.urls')),
    path('ckeditor', include('ckeditor_uploader.urls')),
    path('manifest.json', TemplateView.as_view(template_name="manifest.json", content_type="application/javascript")),
